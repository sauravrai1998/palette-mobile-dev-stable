...
import 'package:palette/modules/todo_module/screens/parent_advisor_view/parent_advisor_created_todo_screen.dart';

import '../../../common_components/custom_circular_indicator.dart';
import '../../../utils/konstants.dart';
import '../../profile_module/models/user_models/advisor_profile_user_model.dart';
import '../bloc/student_list_bloc/advisor_student_bloc.dart';
import '../bloc/student_list_bloc/advisor_student_events.dart';
import '../services/advisor_repository.dart';
import 'advisor_dashboard.dart';

class AdvisorDashboardWithNavbar extends StatefulWidget {
  final AdvisorProfileUserModel? advisor;

  AdvisorDashboardWithNavbar({required this.advisor});
  // const ParentDashboardWithNavbar({Key? key}) : super(key: key);

  @override
  _AdvisorDashboardWithNavbarState createState() =>
      _AdvisorDashboardWithNavbarState();
}

class _AdvisorDashboardWithNavbarState extends State<AdvisorDashboardWithNavbar>
  ...
  Widget build(BuildContext context) {
    List pages = [
      BlocProvider<NotificationsBloc>(
          ...
          child: AdvisorDashboard(advisor: widget.advisor)),
      ParentAdvisorCreatedTodoScreen(
        parentOrAdvisor: widget.advisor,
        isFromAdvisorDashboard: true,
      ),
      Padding(
        ...
        BlocBuilder<BottomNavbarBloc, BottomNavbarState>(
          ...
          return StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                if (unreadCounter > 0) {
                  chatIconString = 'images/unread_chat_icon_nav_bar.svg';
                }
                ...
                print(
                  'chatIconString: $chatIconString, unread: $unreadCounter',
                );
