...
class ShareCreateTodoForm extends StatefulWidget {
  final String urlLink;
  ShareCreateTodoForm({Key? key, required this.urlLink}) : super(key: key);

  @override
  _ShareCreateTodoFormState createState() => _ShareCreateTodoFormState();
}

class _ShareCreateTodoFormState extends State<ShareCreateTodoForm> {
  ...
  bool errorEventDate = false;
  bool errorEventTime = false;
                          ...
                          children: [
                            ...
                            //ShareCreateTodoBloc
                             BlocListener(
                                ...
                                bloc: BlocProvider.of<ShareCreateTodoBloc>(
                                    context),
  ...
  Widget nextButton() {
    return GestureDetector(
      onTap: () {
        ...
        if (isValid()) {
          final detailModel = ShareDetailForTodoViewModel(
          ...
          role.toLowerCase() == 'student'
              ? Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => ShareDetailForTodoView(
