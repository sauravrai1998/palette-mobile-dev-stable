...
import 'package:palette/modules/profile_module/widgets/contact_row_admin.dart';
...
class AdminProfileScreen extends StatefulWidget {
  ...
  bool thirdPerson;
  AdminProfileScreen({required this.admin, this.thirdPerson = false});
  @override
...
class _AdminProfileScreenState extends State<AdminProfileScreen> {
  ...
  void initState() {
    super.initState();
    admin = widget.admin;
    if (admin == null || admin.toString().isEmpty) {
            ...
            child: Semantics(
              ...
              child: Scaffold(
                  ...
                  body: GestureDetector(
                    onTap: () {
                      setState(() => isSettingVisible = false);
                      print('hasDrawer no');
                    },
                    child: widget.thirdPerson == false?
                    Stack(
                      children: [
                    ...
                    BlocBuilder<ThirdPersonBloc, ThirdPersonState>(
                        builder: (context, state) {
                          if (state is ThirdPersonLoadingState) {
                            ...
                            admin =
                            state.profileUser as AdminProfileUserModel;
                            return _getProfileBody(
                                admin: admin!,
                                devWidth: devWidth,
                                devHeight: devHeight);
  ...
  Widget _getProfileBody({
    required AdminProfileUserModel admin,
              ...
              Column(
                children: [
                  ...
                  Padding(
                    ...
                    child:
                        InstituteListWidget(value: 'Institute', educationList: [
                      InstituteDetail(
      ...
      children: [
        ...
        if (widget.thirdPerson == true
          ...
          Positioned(
            left: -10,
            bottom: -10,
            child: ThirdPersonChat(firebaseUuid: admin.firebaseUuid,),
          ),
        if (widget.thirdPerson == true)
          Align(
