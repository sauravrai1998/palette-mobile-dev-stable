...
import '../../profile_module/models/user_models/student_profile_user_model.dart';
import 'todo_list_screen.dart';

class StudentDashboardWithNavbar extends StatefulWidget {
  final StudentProfileUserModel? student;

  StudentDashboardWithNavbar({required this.student});
  // const ParentDashboardWithNavbar({Key? key}) : super(key: key);

  @override
  _StudentDashboardWithNavbarState createState() =>
      _StudentDashboardWithNavbarState();
}

class _StudentDashboardWithNavbarState extends State<StudentDashboardWithNavbar>
  ...
  Widget build(BuildContext context) {
    if (widget.student != null) print("student is " + widget.student!.name);
        ...
        builder: (context, state) {
          return StreamBuilder(
              ...
              builder: (context, snapshot) {
                ...
                // print('chatIconString: $chatIconString');
                return Align(
