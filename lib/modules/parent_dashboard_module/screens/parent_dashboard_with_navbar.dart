...
import '../../profile_module/models/user_models/parent_profile_user_model.dart';
import 'parent_dashboard.dart';

class ParentDashboardWithNavbar extends StatefulWidget {
  final ParentProfileUserModel? parent;

  ParentDashboardWithNavbar({required this.parent});
  // const ParentDashboardWithNavbar({Key? key}) : super(key: key);

  @override
  _ParentDashboardWithNavbarState createState() =>
      _ParentDashboardWithNavbarState();
}

class _ParentDashboardWithNavbarState extends State<ParentDashboardWithNavbar>
  ...
  Widget build(BuildContext context) {
    List pages = [
      BlocProvider<NotificationsBloc>(
          ...
          child: ParentDashboard(parent: widget.parent)),
      ParentAdvisorCreatedTodoScreen(
        parentOrAdvisor: widget.parent,
