...
import 'package:palette/modules/multi_tenant_module/screens/register_screen_multi_tenant.dart';
import 'package:palette/utils/konstants.dart';

import 'login_multi_tenant.dart';
class CheckUserExistScreenMultiTenant extends StatefulWidget {
  const CheckUserExistScreenMultiTenant({Key? key}) : super(key: key);

  @override
  _CheckUserExistScreenMultiTenantState createState() => _CheckUserExistScreenMultiTenantState();
}

class _CheckUserExistScreenMultiTenantState extends State<CheckUserExistScreenMultiTenant> {
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => LoginScreenMultiTenant(),
                          ),
                        );
                      },
                      child: Container(
