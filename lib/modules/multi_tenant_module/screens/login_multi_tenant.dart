...
class LoginScreenMultiTenant extends StatefulWidget {
  const LoginScreenMultiTenant({Key? key}) : super(key: key);

  @override
  _LoginScreenMultiTenantState createState() => _LoginScreenMultiTenantState();
}

class _LoginScreenMultiTenantState extends State<LoginScreenMultiTenant> {
              ...
              Padding(padding: const EdgeInsets.symmetric(horizontal: 50),
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 25,),
                    Text('Enter password',style: roboto700.copyWith(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 14),),
                    SizedBox(height: 5,),
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: 20),
                      decoration: BoxDecoration(
