...
class ObserverDashboard extends StatefulWidget {
  ...
  ObserverDashboard({this.observer});
  @override
  _ObserverDashboardState createState() => _ObserverDashboardState();
}
...
class _ObserverDashboardState extends State<ObserverDashboard>
  ...
  //     /// App was opened from terminated state by chat message...
  ...
  //     /// App was opened from terminated state by todoModule notif...
  ...
  //     /// App was opened from background state (not terminated state)...
  ...
  Widget _failedStateResponseWidget() {
    return Center(
      child: Container(height: 38, width: 50, child: Text('No data to show')),
    );
  }
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  ...
                  if (widget.observer == null) return;
                  final route = MaterialPageRoute(
                      builder: (_) =>
                          ObserverProfileScreen(observer: widget.observer!));
                  Navigator.push(context, route);
                },
                child: Container(
                  child: Stack(children: [
                    SvgPicture.asset(
                      'images/observer_small_splash.svg',
                      height: 130,
                    ...
                    BlocBuilder<ProfileImageBloc, ProfileImageState>(
                      ...
                      if (state is ProfileImageSuccessState) {
                        ...
                        profileImageUrl = widget.observer!.profilePicture;
                      }
                      return Padding(
          ...
          child: Semantics(
            ...
            child: ListTile(
              leading: ExcludeSemantics(
                child: student!.data.mentors[index].profilePicture != null
                    ? CachedNetworkImage(
                        imageUrl:
                            student!.data.mentors[index].profilePicture ?? '',
                        imageBuilder: (context, imageProvider) => Container(
                          width: 42,
                          height: 42,
                          decoration: BoxDecoration(
      ...
      itemBuilder: (_, index) {
        ...
        return Container(
          ...
          child: Semantics(
            ...
            child: ListTile(
              leading: ExcludeSemantics(
                child: student!.data.students[index].profilePicture != null
                    ? CachedNetworkImage(
                        imageUrl:
                            student!.data.students[index].profilePicture ?? '',
                        imageBuilder: (context, imageProvider) => Container(
                          width: 42,
                          height: 42,
                          decoration: BoxDecoration(
              ...
              onTap: () {
                ...
                // var selectedId = student!.data.students[index].id;
                // final bloc = context.read<ThirdPersonBloc>();
                // bloc.add(GetThirdPersonProfileScreenUser(
                //   studentId: selectedId,
                // ));
                ...
                //         directLoad: true, thirdPerson: true),
                //   ),
                // );
              },
            ),
